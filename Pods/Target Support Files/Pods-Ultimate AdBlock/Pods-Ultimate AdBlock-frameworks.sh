...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Purchases-iOS13.0/Purchases.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/PurchasesCoreSwift-iOS13.0/PurchasesCoreSwift.framework"
